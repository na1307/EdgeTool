...
namespace Mygod.Windows.Controls
{
    ...
    [TemplatePart(Name = PART_IncreaseButton, Type = typeof(ButtonBase)),
     TemplatePart(Name = PART_DecreaseButton, Type = typeof(ButtonBase)), ContentProperty("Content")]
    public class ButtonSpinner : Spinner
    {
        ...
        public bool AllowSpin { get { return (bool) GetValue(AllowSpinProperty); } set { SetValue(AllowSpinProperty, value); } }
        ...
        public static readonly DependencyProperty ShowButtonSpinnerProperty = DependencyProperty.Register("ShowButtonSpinner", typeof(bool),
            typeof(ButtonSpinner), new UIPropertyMetadata(true));
