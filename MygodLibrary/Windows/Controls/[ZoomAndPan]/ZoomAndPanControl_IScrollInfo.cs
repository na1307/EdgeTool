...
namespace Mygod.Windows.Controls
{
    ...
    public partial class ZoomAndPanControl
    {
        ...
        /// </summary>
        public double ExtentWidth { get { return unScaledExtent.Width * ContentScale; } }

        /// <summary>
        /// The height of the content (with 'ContentScale' applied).
        /// </summary>
        public double ExtentHeight { get { return unScaledExtent.Height * ContentScale; } }
        ...
        /// </summary>
        public double HorizontalOffset { get { return ContentOffsetX * ContentScale; } }

        /// <summary>
        /// The offset of the vertical scrollbar.
        /// </summary>
        public double VerticalOffset { get { return ContentOffsetY * ContentScale; } }
