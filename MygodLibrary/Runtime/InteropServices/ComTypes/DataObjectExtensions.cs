namespace Mygod.Runtime.InteropServices.ComTypes
{
    using System;
    ...
    public static class ComDataObjectExtensions
    {
        ...
        private const TYMED TYMED_ANY = TYMED.TYMED_ENHMF | TYMED.TYMED_FILE | TYMED.TYMED_GDI | TYMED.TYMED_HGLOBAL | TYMED.TYMED_ISTORAGE | TYMED.TYMED_ISTREAM | TYMED.TYMED_MFPICT;
        ...
        {
            var typeConverterAttrs = (TypeConverterAttribute[]) dataType.GetCustomAttributes(typeof(TypeConverterAttribute), true);
