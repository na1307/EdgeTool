...
{
    /// <summary>
    ///     Defines the interface for proxy serialization with <see cref="BinaryPlistWriter" /> and
    ///     <see
    ///         cref="BinaryPlistReader" />
    ///     .
    /// </summary>
    ...
    public interface IPlistSerializable
    {
        ...
        /// </summary>
        /// <param name="plist">
        ///     The plist <see cref="IDictionary" /> representation of this instance.
        /// </param>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", Justification = "The spelling is correct.")]
        ...
        /// </summary>
        /// <returns>
        ///     A plist-friendly <see cref="IDictionary" /> representation of this instance.
        /// </returns>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", Justification = "The spelling is correct.")]
